...
rsync -v obs.meteor.YYYY-MM-DDTHH-mm.json.tmpl weewx@192.168.1.10:root/skins/Bootstrap/json
rsync -v arch.meteor.YYYY-MM-DDTHH-mm.json.tmpl weewx@192.168.1.10:root/skins/Json/json
