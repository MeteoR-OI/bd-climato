...
class CalculusTestSuite(TestCase):
    ...
    def test_10_max_min_omm_simple_replace(self):
        self.t_engine.run_test('10_max_min_omm_simple_replace')

    def test_11_max_min_forced_replace(self):
        self.t_engine.run_test('11_max_min_forced_replace')

    def test_12_max_min_omm_forced_replace(self):
        self.t_engine.run_test('12_max_min_omm_forced_replace')

    # def test_14_wind_inst_do_not_use_avg(self):
    #     self.t_engine.run_test('14_wind_inst_do_not_use_avg')
