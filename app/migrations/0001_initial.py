    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('j', models.JSONField(default=dict, verbose_name='json data')),
            ],
            options={
                'db_table': 'mesures',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qa_all', models.IntegerField(default=0, null=True, verbose_name='qa_modifications')),
                ('qa_details', models.JSONField(default=dict, null=True, verbose_name='details de qualite par champs')),
                ('qa_modifications', models.IntegerField(default=0, null=True, verbose_name='nombre de modifications')),
