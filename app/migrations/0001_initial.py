# Generated by Django 5.0.2 on 2024-06-05 15:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_key', models.CharField(max_length=50, null=True, verbose_name='Api Key')),
                ...
                ('last_obs_date_local', app.models.DateTimeFieldNoTZ(db_default='2000-01-01T00:00:00', null=True, verbose_name='Datetime local de derniere reception de donnees')),
                ('last_obs_id', models.BigIntegerField(db_default=0, null=True, verbose_name='ID obs de la derniere reception de donnees')),
                ('last_json_date_local', app.models.DateTimeFieldNoTZ(db_default='2100-01-01T00:00:00', null=True, verbose_name='Datetime UTC du premier JSON archivé')),
