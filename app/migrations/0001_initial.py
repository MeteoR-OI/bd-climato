    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('load_type', models.IntegerField(choices=[(0, 'None'), (1, 'Load From Dump'), (2, 'Load From Json'), (4, 'Load From Dump Then Json'), (8, 'Load Txt From Meteofr'), (16, 'Load Csv From Ovpf')], default=0, verbose_name='Type de chargement des donnees')),
