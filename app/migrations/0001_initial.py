# Generated by Django 4.1.7 on 2024-03-25 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_source', models.SmallIntegerField(default=1, verbose_name='Data Source: 0 meteoire, 1 meteofr,..')),
                ('load_type', models.IntegerField(choices=[(0, 'None'), (1, 'Load From Dump'), (2, 'Load From Json'), (3, 'Load From Dump Then Json'), (4, 'Load From Csv File'), (8, 'Load From Meteofr Api'), (12, 'Load From Api And Csv')], default=0, verbose_name='Type de chargement des donnees')),
        ...
        migrations.AddIndex(
            model_name='xmin',
            index=models.Index(fields=['obs_id', 'date_local'], name='x_min_obs_id'),
        ),
        migrations.AddIndex(
            model_name='xmax',
            index=models.Index(fields=['obs_id', 'date_local'], name='x_max_obs_id'),
        ),
        ...
        migrations.AddIndex(
            model_name='lastobs',
            index=models.Index(fields=['poste', 'mesure'], name='last_obs_poste_id'),
        ),
    ]
