...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('start_dat', app.models.DateTimeFieldNoTZ(default='1900-01-01T00:00:00', max_length=20, verbose_name='Date début exclusion')),
                ('stop_dat', app.models.DateTimeFieldNoTZ(default='2100-12-31T23:59:59', max_length=20, verbose_name='Date fin exclusion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(verbose_name="date de l'extrême")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('dat', app.models.DateTimeFieldNoTZ(max_length=30, verbose_name='date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.SmallAutoField(primary_key=True, serialize=False)),
                ('j', models.JSONField(default=dict, null=True, verbose_name='Parametre Json')),
            ],
        ),
        migrations.CreateModel(
            name='Poste',
            fields=[
                ...
                ('start_dat', app.models.DateTimeFieldNoTZ(default='1900-01-01T00:00:00', null=True, verbose_name="Date d'activation")),
                ('stop_dat', app.models.DateTimeFieldNoTZ(default='2100-12-31T23:59:59', null=True, verbose_name='Date de désactivation')),
                ('comment', models.TextField(default='', null=True)),
                ('last_obs_date', app.models.DateTimeFieldNoTZ(default='2000-01-01T00:00:00', null=True, verbose_name='Date de derniere reception de donnees')),
                ('last_obs_id', models.BigIntegerField(default=0, null=True, verbose_name='ID obs de la derniere reception de donnees')),
                ('last_extremes_date', app.models.DateTimeFieldNoTZ(default='2000-01-01T00:00:00', null=True, verbose_name='Date de dernier record')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', app.models.DateTimeFieldNoTZ(verbose_name='date fin période observation')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['poste_id', '-time'], name='obs_pid'),
        ),
        migrations.AddIndex(
            model_name='extreme',
            index=models.Index(fields=['poste_id', '-date'], name='extremes_pid'),
        ),
    ]
