...
class TypeInstrument(models.Model):
    ...
    model_value = DateJSONField(null=False, max_length=64500, verbose_name="JsonB")
...
class Exclusion(models.Model):
    ...
    start_dat = DateCharField(null=False, max_length=20, default="1900-01-01T00:00:00", verbose_name="start date")
    stop_dat = DateCharField(null=False, max_length=20, default="2100-12-31T23:59:59", verbose_name="stop date")
    value = DateJSONField(null=False, max_length=64500, verbose_name="JsonB")
...
class Observation(models.Model):
    ...
    j = DateJSONField(null=False)
    j_agg = DateJSONField(null=False)
...
class Agg_todo(models.Model):
    ...
    j_dv = DateJSONField(null=False, max_length=64500, verbose_name='default_values coming from obs processing')
    j_error = DateJSONField(null=False, max_length=64500, verbose_name='error reporting')
...
class Extreme_todo(models.Model):
    ...
    status = models.IntegerField(null=False, default=0, verbose_name='status, 0: wait, 9: error, 99: processed')
    j_invalid = DateJSONField(null=False)
