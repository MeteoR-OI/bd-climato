...
('BAG280',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  280, 0, 0, 1, 'mon api key 007'),
('BBF015',   4, 1, 'VP2', 'Micolas Cuvillier', 'micka@meteor-oi.re', '0612345678', 'Bain Boeuf', 'Bain boeuf', 'Maurice',  15,  -20.933387, 55.582768, 1, 'mon api key 007'),
('BDN240',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  240, 0, 0, 1, 'mon api key 007'),
('BER590',   4, 1, 'VP2', 'Sabine/Pierre', 'micka@meteor-oi.re', '0612345678', 'Bérive 590', 'Le Tampon', 'la réunion',  590, -21.309871, 55.537723, 1, 'mon api key 007'),
('BER605',   4, 1, 'VP2', 'Véronique', 'micka@meteor-oi.re', '0612345678', 'Bérive 605', 'Le Tampon', 'la réunion',  605, -21.30833, 55.53887, 1, 'mon api key 007'),
('BOCO1370', 4, 1, 'VP2', 'Donny', 'micka@meteor-oi.re', '0612345678', 'Bois court', 'Le Tampon', 'la réunion',  1370,  -21.196061, 55.53827, 1, 'mon api key 007'),
('BOMU1610', 4, 1, 'VP2', 'Patrice', 'micka@meteor-oi.re', '0612345678', 'Bourg Murat', 'Le Tampon', 'la réunion',  1600, -21.192665, 55.576251, 1, 'mon api key 007'),
('BP130',    4, 1, 'VP2', 'Alexandre Nativel', 'micka@meteor-oi.re', '0612345678', 'Bassin Plat', 'Saint Pierre', 'la réunion',  135, -21.330492, 55.489393, 1, 'mon api key 007'),
('BPN100',   4, 1, 'VP2', 'Ami de Jack Quillet', 'micka@meteor-oi.re', '0612345678', 'La caroline', 'Bras Panon', 'la réunion',  100, -21.002163, 55.652502, 1, 'mon api key 007'),
('BRL030',   4, 1, 'VP2', 'Geoffroy', 'micka@meteor-oi.re', '0612345678', 'Baril', 'Saint Philippe', 'la réunion',  80, -21.362132, 55.725414, 1, 'mon api key 007'),
('BRT155',   4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'La Bretagne', 'Saint Denis', 'la réunion',  155, -20.912244, 55.493962, 1, 'mon api key 007'),
('BRT240',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  240,  0, 0, 1, 'mon api key 007'),
('CAM015',   4, 1, 'VP2', 'Entreprise Drone', 'micka@meteor-oi.re', '0612345678', 'Cambaie', 'Saint Paul', 'la réunion',  20, -20.961875, 55.282956, 1, 'mon api key 007'),
('CBG270',   4, 1, 'VP2', 'Tony', 'micka@meteor-oi.re', '0612345678', 'Cambourg', 'Saint Benoit', 'la réunion',  260, -21.113488, 55.728536, 1, 'mon api key 007'),
('CHAR645',  4, 1, 'VP2', 'Frederik/Caroline', 'micka@meteor-oi.re', '0612345678', 'Charrié', 'Petite Ile', 'la réunion',  645, -21.192665, 55.576251, 1, 'mon api key 007'),
('CHP690',   4, 1, 'Vue', 'Thiébaut', 'micka@meteor-oi.re', '0612345678', 'La Chapelle/†evelave', 'Les Avirons', 'la réunion', 6900, -21.220226, 55.344443, 1, 'mon api key 007'),
('CRT630',   4, 1, 'Vue', 'Micka', 'micka@meteor-oi.re', '0612345678', 'La Crete 1', 'Saint Joseph', 'la réunion',  630,  -21.335742, 55.656652, 1, 'mon api key 007'),
('CRT635',   4, 1, 'Vue', 'Micka', 'micka@meteor-oi.re', '0612345678', 'La Crete 2', 'Saint Joseph', 'la réunion',  635,  -21.340014, 55.667172, 1, 'mon api key 007'),
('CUP575',   4, 1, 'Vue', 'Vishal', 'micka@meteor-oi.re', '0612345678', 'Curepipe', 'Curepipe', 'Maurice',  575,   -20.933387, 55.582768, 1, 'mon api key 007'),
('ELH675',   4, 1, 'Vue', 'Mat/Actus Meteo 974', 'micka@meteor-oi.re', '0612345678', 'Esperance les hauts', 'Saint Marie', 'la réunion',  670,  -20.950965, 55.516872, 1, 'mon api key 007'),
('ESB005',   4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Etang Salé les Bains', 'Etang Salé', 'la réunion',  10, -21.26778775, 55.335363, 1, 'mon api key 007'),
('ESH555',   4, 1, 'VP2', 'Laurent', 'micka@meteor-oi.re', '0612345678', 'Etang Salé', 'Etang Salé', 'la réunion',  555, -21.236787, 55.378695, 1, 'mon api key 007'),
('FAY040',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  40, -20.941706, 55.65897, 1, 'mon api key 007'),
('GDC030',   4, 1, 'VP2', 'Sébastien Langlade', 'micka@meteor-oi.re', '0612345678', 'Grand Canal', 'Saint André', 'la réunion',  27, -20.95888, 55.689574, 1, 'mon api key 007'),
('GFD010',   4, 1, 'VP2', 'Thierry François', 'micka@meteor-oi.re', '0612345678', 'Grand Fond', 'Saint Paul', 'la réunion',  10, -21.26778775, 55.219428, 1, 'mon api key 007'),
('LAN030',   4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Langevin', 'Saint Joseph', 'la réunion',  40,  -21.384245, 55.647383, 1, 'mon api key 007'),
('LCV050',   4, 1, 'VP2', 'Philippe', 'micka@meteor-oi.re', '0612345678', 'La Convenance', 'Sainte Marie', 'la réunion',  45,  -20.895952, 55.572072, 1, 'mon api key 007'),
('MAK805',   4, 1, 'VP2', 'Jimmy', 'micka@meteor-oi.re', '0612345678', 'Les Makes', 'Saint Louis', 'la réunion',  800, -21.217226, 55.405008, 1, 'mon api key 007'),
('MAT315',   4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Matouta', 'Saint Joseph', 'la réunion',  315, -21.360229, 55.70152, 1, 'mon api key 007'),
('MDM1570',  4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Marla', 'Saint Paul', 'la réunion',  1570, -21.100918, 55.430022, 1, 'mon api key 007'),
('MTG280',   4, 1, 'VP2', 'Fréderic Caillé', 'micka@meteor-oi.re', '0612345678', 'La Montagne', 'Saint Denis', 'la réunion',  260, -20.878348, 55.428241, 1, 'mon api key 007'),
('MTG320',   4, 1, 'VP2', 'Hubert', 'micka@meteor-oi.re', '0612345678', 'La Montagne', 'Saint Denis', 'la réunion',  320, -20.882, 55.424667, 1, 'mon api key 007'),
('MVP860',   4, 1, 'VP2', 'Jack Quillet', 'micka@meteor-oi.re', '0612345678', 'Mare à Vieille Place', 'Salazie', 'la réunion',  860, -21.025844, 55.515549, 1, 'mon api key 007'),
('NDLP1520', 4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Nogtre Dame de la Paix', 'Le Tampon', 'la réunion',  1520, -21.250525, 55.584708, 1, 'mon api key 007'),
('PAH575',   4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Piton Armand les Hauts', 'Saint Benoit', 'la réunion',  575,  -21.122265, 55.703658, 1, 'mon api key 007'),
('PDO1600',  4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Bourg Murat', 'la réunion',  280, 0, 0, 1, 'mon api key 007'),
('PFD040',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  40,  -21.300325, 55.418679, 1, 'mon api key 007'),
('PSL310',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  310,  -21.300325, 55.418679, 1, 'mon api key 007'),
('RAM450',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  450,  -20.928899, 55.365116, 1, 'mon api key 007'),
('ROQ070',   4, 1, 'Vue', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  70, -21.059036, 55.229183, 1, 'mon api key 007'),
('SPC010',   4, 1, 'Vue', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  10, -21.053141, 55.695668, 1, 'mon api key 007'),
('SBBM100',  4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  100, -21.053141, 55.695668, 1, 'mon api key 007'),
('TAM1790',  4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  1790,  -21.106126, 55.362666, 1, 'mon api key 007'),
('TAN1270',  3, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  1270,  -21.106126, 55.362666, 1, 'mon api key 007'),
('TAR600',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  600,  -21.059972, 55.289673, 1, 'mon api key 007'),
('TBL105',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  105, -21.317372, 55.800674, 1, 'mon api key 007'),
('TRG170',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  170, -21.338827, 55.51276, 1, 'mon api key 007'),
('TRM490',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  490, -21.26666, 55.495548, 1, 'mon api key 007')
;
...
('LE TEVELAVE', 4, 2, '97401520', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LE TEVELAVE', 'LE TEVELAVE', 'la réunion', 908, 21.21166667, 55.36111111, 8),
('LES AVIRONS-CIRAD', 4, 2, '97401540', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LES AVIRONS-CIRAD', 'LES AVIRONS-CIRAD', 'la réunion', 180, 21.23944444, 55.3275, 8),
('BELLEVUE BRAS-PANON', 4, 2, '97402240', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'BELLEVUE BRAS-PANON', 'BELLEVUE BRAS-PANON', 'la réunion', 480, 21.00472222, 55.6225, 8),
('LE DIMITILE_SAPC', 4, 2, '97403410', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LE DIMITILE_SAPC', 'LE DIMITILE_SAPC', 'la réunion', 1808, 21.18888889, 55.48138889, 8),
('BRAS-LONG_SAPC', 4, 2, '97403435', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'BRAS-LONG_SAPC', 'BRAS-LONG_SAPC', 'la réunion', 510, 21.22805556, 55.47444444, 8),
('PONT-MATHURIN', 4, 2, '97404540', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PONT-MATHURIN', 'PONT-MATHURIN', 'la réunion', 19, 21.265, 55.38, 8),
('PITON-BLOC_SAPC', 4, 2, '97405420', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PITON-BLOC_SAPC', 'PITON-BLOC_SAPC', 'la réunion', 812, 21.32111111, 55.57222222, 8),
('PLAINE DES PALMISTES', 4, 2, '97406220', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PLAINE DES PALMISTES', 'PLAINE DES PALMISTES', 'la réunion', 1032, 21.13611111, 55.62694444, 8),
('LE PORT', 4, 2, '97407520', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LE PORT', 'LE PORT', 'la réunion', 9, 20.94611111, 55.28194444, 8),
('POSSESSION', 4, 2, '97408510', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'POSSESSION', 'POSSESSION', 'la réunion', 9, 20.92111111, 55.34611111, 8),
('POSSESSION-P2', 4, 2, '97408511', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'POSSESSION-P2', 'POSSESSION-P2', 'la réunion', 9, 20.92111111, 55.34611111, 8),
('AURERE_SAPC', 4, 2, '97408560', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'AURERE_SAPC', 'AURERE_SAPC', 'la réunion', 940, 21.01861111, 55.42472222, 8),
('LA NOUVELLE_SAPC', 4, 2, '97408580', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LA NOUVELLE_SAPC', 'LA NOUVELLE_SAPC', 'la réunion', 1415, 21.07666667, 55.42305556, 8),
('DOS D ANE', 4, 2, '97408582', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'DOS D ANE', 'DOS D ANE', 'la réunion', 1027, 20.97833333, 55.39027778, 8),
('BOIS-ROUGE', 4, 2, '97409210', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'BOIS-ROUGE', 'BOIS-ROUGE', 'la réunion', 5, 20.91361111, 55.64111111, 8),
('MENCIOL', 4, 2, '97409240', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'MENCIOL', 'MENCIOL', 'la réunion', 181, 20.96111111, 55.62555556, 8),
('BEAUVALLON', 4, 2, '97410202', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'BEAUVALLON', 'BEAUVALLON', 'la réunion', 16, 21.00777778, 55.69305556, 8),
('SAINT-BENOIT', 4, 2, '97410238', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'SAINT-BENOIT', 'SAINT-BENOIT', 'la réunion', 43, 21.05861111, 55.71916667, 8),
('TAKAMAKA-PK12_SAPC', 4, 2, '97410250', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'TAKAMAKA-PK12_SAPC', 'TAKAMAKA-PK12_SAPC', 'la réunion', 660, 21.07611111, 55.63055556, 8),
('CHEMIN DE CEINTURE_SAPC', 4, 2, '97410265', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'CHEMIN DE CEINTURE_SAPC', 'CHEMIN DE CEINTURE_SAPC', 'la réunion', 255, 21.07611111, 55.68527778, 8),
('CHAUDRON', 4, 2, '97411132', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'CHAUDRON', 'CHAUDRON', 'la réunion', 38, 20.89694444, 55.49472222, 8),
('GRANDE-CHALOUPE', 4, 2, '97411141', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'GRANDE-CHALOUPE', 'GRANDE-CHALOUPE', 'la réunion', 10, 20.89805556, 55.36972222, 8),
('GRANDE-CHALOUPE-P2', 4, 2, '97411142', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'GRANDE-CHALOUPE-P2', 'GRANDE-CHALOUPE-P2', 'la réunion', 7, 20.89777778, 55.375, 8),
('COLORADO_SAPC', 4, 2, '97411146', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'COLORADO_SAPC', 'COLORADO_SAPC', 'la réunion', 702, 20.91027778, 55.42138889, 8),
('SAINT-FRANCOIS', 4, 2, '97411150', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'SAINT-FRANCOIS', 'SAINT-FRANCOIS', 'la réunion', 545, 20.92111111, 55.45611111, 8),
('MONTAUBAN_SAPC', 4, 2, '97411155', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'MONTAUBAN_SAPC', 'MONTAUBAN_SAPC', 'la réunion', 420, 20.93861111, 55.49666667, 8),
('LE BRULE-VAL FLEURI_SAPC', 4, 2, '97411164', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LE BRULE-VAL FLEURI_SAPC', 'LE BRULE-VAL FLEURI_SAPC', 'la réunion', 1069, 20.94166667, 55.42944444, 8),
('PLAINE DES CHICOTS_SAPC', 4, 2, '97411170', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PLAINE DES CHICOTS_SAPC', 'PLAINE DES CHICOTS_SAPC', 'la réunion', 1834, 20.98722222, 55.44472222, 8),
('COMMERSON_SAPC', 4, 2, '97412302', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'COMMERSON_SAPC', 'COMMERSON_SAPC', 'la réunion', 2310, 21.20777778, 55.64361111, 8),
('GRAND-COUDE_SAPC', 4, 2, '97412336', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'GRAND-COUDE_SAPC', 'GRAND-COUDE_SAPC', 'la réunion', 1085, 21.30166667, 55.63111111, 8),
('GRAND-GALET', 4, 2, '97412340', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'GRAND-GALET', 'GRAND-GALET', 'la réunion', 505, 21.31083333, 55.63944444, 8),
('LA CRETE_SAPC', 4, 2, '97412356', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LA CRETE_SAPC', 'LA CRETE_SAPC', 'la réunion', 659, 21.33722222, 55.6675, 8),
('ST-JOSEPH_SAPC', 4, 2, '97412384', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'ST-JOSEPH_SAPC', 'ST-JOSEPH_SAPC', 'la réunion', 13, 21.385, 55.60944444, 8),
('COLIMACONS', 4, 2, '97413520', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'COLIMACONS', 'COLIMACONS', 'la réunion', 798, 21.13027778, 55.30444444, 8),
('ST-LEU', 4, 2, '97413542', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'ST-LEU', 'ST-LEU', 'la réunion', 79, 21.19, 55.29222222, 8),
('PITON SAINT-LEU_SAPC', 4, 2, '97413580', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PITON SAINT-LEU_SAPC', 'PITON SAINT-LEU_SAPC', 'la réunion', 530, 21.215, 55.32555556, 8),
('PLAINE DES MAKES_SAPC', 4, 2, '97414409', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PLAINE DES MAKES_SAPC', 'PLAINE DES MAKES_SAPC', 'la réunion', 980, 21.19944444, 55.40916667, 8),
('LE TAPAGE-CIRAD', 4, 2, '97414451', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LE TAPAGE-CIRAD', 'LE TAPAGE-CIRAD', 'la réunion', 863, 21.22444444, 55.44416667, 8),
('SAINT-PAUL-CIRAD', 4, 2, '97415511', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'SAINT-PAUL-CIRAD', 'SAINT-PAUL-CIRAD', 'la réunion', 186, 20.97527778, 55.325, 8),
('BOIS DE NEFLES ST-PAUL_SAPC', 4, 2, '97415516', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'BOIS DE NEFLES ST-PAUL_SAPC', 'BOIS DE NEFLES ST-PAUL_SAPC', 'la réunion', 595, 20.99722222, 55.34111111, 8),
('PETITE-FRANCE', 4, 2, '97415536', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PETITE-FRANCE', 'PETITE-FRANCE', 'la réunion', 1200, 21.045, 55.34194444, 8),
('TAN-ROUGE_SAPC', 4, 2, '97415541', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'TAN-ROUGE_SAPC', 'TAN-ROUGE_SAPC', 'la réunion', 750, 21.06916667, 55.29944444, 8),
('L ERMITAGE-CIRAD', 4, 2, '97415550', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'L ERMITAGE-CIRAD', 'L ERMITAGE-CIRAD', 'la réunion', 147, 21.05277778, 55.24111111, 8),
('LE GUILLAUME', 4, 2, '97415557', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LE GUILLAUME', 'LE GUILLAUME', 'la réunion', 1035, 21.06444444, 55.32416667, 8),
('PITON-MAIDO', 4, 2, '97415566', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PITON-MAIDO', 'PITON-MAIDO', 'la réunion', 2150, 21.07666667, 55.38111111, 8),
('VUE-BELLE LES HAUTS-CIRAD', 4, 2, '97415579', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'VUE-BELLE LES HAUTS-CIRAD', 'VUE-BELLE LES HAUTS-CIRAD', 'la réunion', 722, 21.08194444, 55.2925, 8),
('POINTE DES TROIS-BASSINS', 4, 2, '97415590', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'POINTE DES TROIS-BASSINS', 'POINTE DES TROIS-BASSINS', 'la réunion', 5, 21.105, 55.2475, 8),
('PIERREFONDS-AEROPORT', 4, 2, '97416463', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PIERREFONDS-AEROPORT', 'PIERREFONDS-AEROPORT', 'la réunion', 21, 21.32, 55.42527778, 8),
('LIGNE-PARADIS-CIRAD', 4, 2, '97416465', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LIGNE-PARADIS-CIRAD', 'LIGNE-PARADIS-CIRAD', 'la réunion', 156, 21.31916667, 55.485, 8),
('LE TREMBLET', 4, 2, '97417340', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LE TREMBLET', 'LE TREMBLET', 'la réunion', 91, 21.31722222, 55.80083333, 8),
('LE BARIL', 4, 2, '97417360', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LE BARIL', 'LE BARIL', 'la réunion', 114, 21.35888889, 55.73194444, 8),
('GILLOT-AEROPORT', 4, 2, '97418110', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'GILLOT-AEROPORT', 'GILLOT-AEROPORT', 'la réunion', 8, 20.89194444, 55.52861111, 8),
('LA MARE-CIRAD', 4, 2, '97418123', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'LA MARE-CIRAD', 'LA MARE-CIRAD', 'la réunion', 68, 20.90333333, 55.53194444, 8),
('PLAINE DES FOUGERES_SAPC', 4, 2, '97418170', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PLAINE DES FOUGERES_SAPC', 'PLAINE DES FOUGERES_SAPC', 'la réunion', 1064, 20.96722222, 55.52777778, 8),
('RIVIERE DE L EST-CIRAD', 4, 2, '97419310', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'RIVIERE DE L EST-CIRAD', 'RIVIERE DE L EST-CIRAD', 'la réunion', 144, 21.12, 55.75861111, 8),
('HAUTS DE SAINTE-ROSE_SAPC', 4, 2, '97419320', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'HAUTS DE SAINTE-ROSE_SAPC', 'HAUTS DE SAINTE-ROSE_SAPC', 'la réunion', 820, 21.15944444, 55.76361111, 8),
('GROS PITON SAINTE-ROSE', 4, 2, '97419350', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'GROS PITON SAINTE-ROSE', 'GROS PITON SAINTE-ROSE', 'la réunion', 181, 21.17944444, 55.82861111, 8),
('BELLECOMBE-JACOB', 4, 2, '97419380', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'BELLECOMBE-JACOB', 'BELLECOMBE-JACOB', 'la réunion', 2245, 21.21777778, 55.68694444, 8),
('GRAND-HAZIER-CIRAD', 4, 2, '97420110', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'GRAND-HAZIER-CIRAD', 'GRAND-HAZIER-CIRAD', 'la réunion', 69, 20.90277778, 55.58583333, 8),
('BAGATELLE_SAPC', 4, 2, '97420150', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'BAGATELLE_SAPC', 'BAGATELLE_SAPC', 'la réunion', 262, 20.93083333, 55.57666667, 8),
('BRAS-PISTOLET_SAPC', 4, 2, '97420180', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'BRAS-PISTOLET_SAPC', 'BRAS-PISTOLET_SAPC', 'la réunion', 556, 20.96888889, 55.58722222, 8),
('MARE A VIEILLE PLACE', 4, 2, '97421210', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'MARE A VIEILLE PLACE', 'MARE A VIEILLE PLACE', 'la réunion', 870, 21.02777778, 55.51194444, 8),
('GRAND-ILET_SAPC', 4, 2, '97421220', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'GRAND-ILET_SAPC', 'GRAND-ILET_SAPC', 'la réunion', 1185, 21.02861111, 55.47166667, 8),
('SALAZIE-VILLAGE_SAPC', 4, 2, '97421240', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'SALAZIE-VILLAGE_SAPC', 'SALAZIE-VILLAGE_SAPC', 'la réunion', 476, 21.03166667, 55.53833333, 8),
('BELOUVE_SAPC', 4, 2, '97421260', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'BELOUVE_SAPC', 'BELOUVE_SAPC', 'la réunion', 1500, 21.06055556, 55.53638889, 8),
('ILET A VIDOT_SAPC', 4, 2, '97421265', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'ILET A VIDOT_SAPC', 'ILET A VIDOT_SAPC', 'la réunion', 940, 21.06305556, 55.51027778, 8),
('PLAINE DES CAFRES', 4, 2, '97422440', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PLAINE DES CAFRES', 'PLAINE DES CAFRES', 'la réunion', 1560, 21.20916667, 55.57277778, 8),
('BRAS-SEC', 4, 2, '97422445', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'BRAS-SEC', 'BRAS-SEC', 'la réunion', 1210, 21.20555556, 55.525, 8),
('PONT D YVES', 4, 2, '97422455', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PONT D YVES', 'PONT D YVES', 'la réunion', 835, 21.23111111, 55.50305556, 8),
('CILAOS', 4, 2, '97424410', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'CILAOS', 'CILAOS', 'la réunion', 1197, 21.13416667, 55.47166667, 8),
('ILET A CORDES_SAPC', 4, 2, '97424450', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'ILET A CORDES_SAPC', 'ILET A CORDES_SAPC', 'la réunion', 1067, 21.15333333, 55.43805556, 8),
('PALMISTE-ROUGE', 4, 2, '97424460', 'station meteoFR', 'Micka', 'micka@meteor-oi.re', '0612345678', 'PALMISTE-ROUGE', 'PALMISTE-ROUGE', 'la réunion', 830, 21.16861111, 55.47444444, 8)
;
