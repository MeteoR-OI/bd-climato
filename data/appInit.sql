...
('BAG280',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  280, 0, 0, 1),
('BBF015',   4, 1, 'VP2', 'Micolas Cuvillier', 'micka@meteor-oi.re', '0612345678', 'Bain Boeuf', 'Bain boeuf', 'Maurice',  15,  -20.933387, 55.582768, 1),
('BDN240',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  240, 0, 0, 1),
('BER590',   4, 1, 'VP2', 'Sabine/Pierre', 'micka@meteor-oi.re', '0612345678', 'Bérive 590', 'Le Tampon', 'la réunion',  590, -21.309871, 55.537723, 1),
('BER605',   4, 1, 'VP2', 'Véronique', 'micka@meteor-oi.re', '0612345678', 'Bérive 605', 'Le Tampon', 'la réunion',  605, -21.30833, 55.53887, 1),
('BOCO1370', 4, 1, 'VP2', 'Donny', 'micka@meteor-oi.re', '0612345678', 'Bois court', 'Le Tampon', 'la réunion',  1370,  -21.196061, 55.53827, 1),
('BOMU1610', 4, 1, 'VP2', 'Patrice', 'micka@meteor-oi.re', '0612345678', 'Bourg Murat', 'Le Tampon', 'la réunion',  1600, -21.192665, 55.576251, 1),
('BP130',    4, 1, 'VP2', 'Alexandre Nativel', 'micka@meteor-oi.re', '0612345678', 'Bassin Plat', 'Saint Pierre', 'la réunion',  135, -21.330492, 55.489393, 1),
('BPN100',   4, 1, 'VP2', 'Ami de Jack Quillet', 'micka@meteor-oi.re', '0612345678', 'La caroline', 'Bras Panon', 'la réunion',  100, -21.002163, 55.652502, 1),
('BRL030',   4, 1, 'VP2', 'Geoffroy', 'micka@meteor-oi.re', '0612345678', 'Baril', 'Saint Philippe', 'la réunion',  80, -21.362132, 55.725414, 1),
('BRT155',   4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'La Bretagne', 'Saint Denis', 'la réunion',  155, -20.912244, 55.493962, 1),
('BRT240',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  240,  0, 0, 1),
('CAM015',   4, 1, 'VP2', 'Entreprise Drone', 'micka@meteor-oi.re', '0612345678', 'Cambaie', 'Saint Paul', 'la réunion',  20, -20.961875, 55.282956, 1),
('CBG270',   4, 1, 'VP2', 'Tony', 'micka@meteor-oi.re', '0612345678', 'Cambourg', 'Saint Benoit', 'la réunion',  260, -21.113488, 55.728536, 1),
('CHAR645',  4, 1, 'VP2', 'Frederik/Caroline', 'micka@meteor-oi.re', '0612345678', 'Charrié', 'Petite Ile', 'la réunion',  645, -21.192665, 55.576251, 1),
('CHP690',   4, 1, 'Vue', 'Thiébaut', 'micka@meteor-oi.re', '0612345678', 'La Chapelle/†evelave', 'Les Avirons', 'la réunion', 6900, -21.220226, 55.344443, 1),
('CRT630',   4, 1, 'Vue', 'Micka', 'micka@meteor-oi.re', '0612345678', 'La Crete 1', 'Saint Joseph', 'la réunion',  630,  -21.335742, 55.656652, 1),
('CRT635',   4, 1, 'Vue', 'Micka', 'micka@meteor-oi.re', '0612345678', 'La Crete 2', 'Saint Joseph', 'la réunion',  635,  -21.340014, 55.667172, 1),
('CUP575',   4, 1, 'Vue', 'Vishal', 'micka@meteor-oi.re', '0612345678', 'Curepipe', 'Curepipe', 'Maurice',  575,   -20.933387, 55.582768, 1),
('ELH675',   4, 1, 'Vue', 'Mat/Actus Meteo 974', 'micka@meteor-oi.re', '0612345678', 'Esperance les hauts', 'Saint Marie', 'la réunion',  670,  -20.950965, 55.516872, 1),
('ESB005',   4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Etang Salé les Bains', 'Etang Salé', 'la réunion',  10, -21.26778775, 55.335363, 1),
('ESH555',   4, 1, 'VP2', 'Laurent', 'micka@meteor-oi.re', '0612345678', 'Etang Salé', 'Etang Salé', 'la réunion',  555, -21.236787, 55.378695, 1),
('FAY040',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  40, -20.941706, 55.65897, 1),
('GDC030',   4, 1, 'VP2', 'Sébastien Langlade', 'micka@meteor-oi.re', '0612345678', 'Grand Canal', 'Saint André', 'la réunion',  27, -20.95888, 55.689574, 1),
('GFD010',   4, 1, 'VP2', 'Thierry François', 'micka@meteor-oi.re', '0612345678', 'Grand Fond', 'Saint Paul', 'la réunion',  10, -21.26778775, 55.219428, 1),
('LAN030',   4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Langevin', 'Saint Joseph', 'la réunion',  40,  -21.384245, 55.647383, 1),
('LCV050',   4, 1, 'VP2', 'Philippe', 'micka@meteor-oi.re', '0612345678', 'La Convenance', 'Sainte Marie', 'la réunion',  45,  -20.895952, 55.572072, 1),
('MAK805',   4, 1, 'VP2', 'Jimmy', 'micka@meteor-oi.re', '0612345678', 'Les Makes', 'Saint Louis', 'la réunion',  800, -21.217226, 55.405008, 1),
('MAT315',   4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Matouta', 'Saint Joseph', 'la réunion',  315, -21.360229, 55.70152, 1),
('MDM1570',  4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Marla', 'Saint Paul', 'la réunion',  1570, -21.100918, 55.430022, 1),
('MTG280',   4, 1, 'VP2', 'Fréderic Caillé', 'micka@meteor-oi.re', '0612345678', 'La Montagne', 'Saint Denis', 'la réunion',  260, -20.878348, 55.428241, 1),
('MTG320',   4, 1, 'VP2', 'Hubert', 'micka@meteor-oi.re', '0612345678', 'La Montagne', 'Saint Denis', 'la réunion',  320, -20.882, 55.424667, 1),
('MVP860',   4, 1, 'VP2', 'Jack Quillet', 'micka@meteor-oi.re', '0612345678', 'Mare à Vieille Place', 'Salazie', 'la réunion',  860, -21.025844, 55.515549, 1),
('NDLP1520', 4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Nogtre Dame de la Paix', 'Le Tampon', 'la réunion',  1520, -21.250525, 55.584708, 1),
('PAH575',   4, 1, 'VP2', 'Association', 'micka@meteor-oi.re', '0612345678', 'Piton Armand les Hauts', 'Saint Benoit', 'la réunion',  575,  -21.122265, 55.703658, 1),
('PDO1600',  4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Bourg Murat', 'la réunion',  280, 0, 0, 1),
('PFD040',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  40,  -21.300325, 55.418679, 1),
('PSL310',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  310,  -21.300325, 55.418679, 1),
('RAM450',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  450,  -20.928899, 55.365116, 1),
('ROQ070',   4, 1, 'Vue', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  70, -21.059036, 55.229183, 1),
...
('TRM490',   4, 1, 'VP2', 'Micka', 'micka@meteor-oi.re', '0612345678', 'quartier', 'Commune', 'la réunion',  490, -21.26666, 55.495548, 1)
;
