...
class INSTAN(models.Model): #Classe de données instantanées
    ...
    RR = models.FloatField(null=True, default = np.nan)
    RRI = models.FloatField(null=True,verbose_name="Intensité max des precipitations", default = np.nan)
    FF = models.FloatField(null=True, default = np.nan)
    DD = models.FloatField(null=True, default = np.nan)
    FXI = models.FloatField(null=True, default = np.nan)
    DXI = models.FloatField(null=True, default = np.nan)
    T = models.FloatField(null=True, default = np.nan)
    TD = models.FloatField(null=True, default = np.nan)
    U = models.FloatField(null=True, default = np.nan)
    PMER = models.FloatField(null=True, default = np.nan)
    UV = models.FloatField(null=True,verbose_name = "Indice UV", default = np.nan)
    RAD =models.FloatField(null=True, default = np.nan)
    IC = models.FloatField(null=True,verbose_name = "Indice de chaleur", default = np.nan)
    WINDCHILL = models.FloatField(null=True, default = np.nan)
    ETP = models.FloatField(null=True,verbose_name="Evapotranspiration", default = np.nan)
    HF = models.FloatField(null=True, verbose_name="Humidite du feuillage", default = np.nan)
    HS = models.FloatField(null=True,verbose_name="Humidite du sol", default = np.nan)
    TS = models.FloatField(null=True,verbose_name="Temperature du sol", default = np.nan)
