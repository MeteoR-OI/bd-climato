...
rsync -v weewx_json.conf weewx@192.168.1.10:root/skins/Json/weewx.conf
...
rsync -v skin_Images.conf weewx@192.168.1.10:root/skins/Images/skin.conf
...
rsync -v historygenerator.py weewx@192.168.1.10:root/bin/weewx
rsync -v index.html.tmpl weewx@192.168.1.10:root/skins/Bootstrap
rsync -v cron.weewx weewx@192.168.1.10:root
rsync -v trans_json.sh weewx@192.168.1.10:root
rsync -v trans_json_local.sh weewx@192.168.1.10:root
